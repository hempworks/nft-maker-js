...
import { resolveConfiguration, shouldIncludeTraitInMetadata } from '../src/util'
...
//
//     const shouldIncludeTraitMock = <
//       jest.Mock<typeof shouldIncludeTraitInMetadata>
...
//     )
//
//     expect(shouldIncludeTraitInMetadata).toHaveBeenCalledTimes(2)
//
...
describe('trait compatibility checking', () => {
  it('should not include incompatible traits', () => {})
})
